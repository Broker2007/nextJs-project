...
import door from "@/assets/product/door.jpg"
...
//     механическая обработка деталей 2
    {
        ...
        categories:2,
        src:door,
        description:["Двери противопожарные металлические различают по времени горения (30 минут, 45 минут, 60 минут) обозначаются как EI30, EI45,EI60. Двери имеют особую конструкциюю и огнестойкие материалы они также оборудованы огнестойкой фурнитурой  которая позволяет открывать их даже в условиях высоких температур. Для мест с высокой проходимостью людей предусмотрены двери с установленной «ручкой-антипаникой»,которая позволяет быстро открыть дверь в случае опасности и обеспечивает простоту эвакуации. Противопожарные двери могут комплектоваться специальным противопожарным стеклопакетом. Предлагаем также тамбурные, подъездные двери, которые состоят из двух дверных полотен. Такие двери созданы для заноса мебели, крупной бытовой техники. Створки таких дверей состоят как правило из двух частей, активной створкой и постоянно закрыой (с возможность открывания). Окраска дверей производится в соответствии с каталогом RAL.",<br/>,<br/>, "По всем вопросам звоните на номер:+7 (901) 181-11-12"],
        characteristic: [
            {
                titleC: "Выполняется",
                descriptionC: "НА ЗАКАЗ"
