...
const ProductsData = [
    ...
    {
        id:200,
        title:"Ограждение лестничных маршей",
        categories:1,
        src: ogr2,
        description: "Ограждение лестничных маршей—это барьер, который предназначен для задержки, остановки или направления людей, а также для защиты от случайных падений с одного уровня на другой",
        characteristic: [
            {
                titleC: "Высота перил",
                descriptionC: "90см"
            ...
            {
                titleC: "Высота поручня",
                descriptionC: "110см"
            },
            {
                titleC: "Ширина поручня",
                descriptionC: "30-70мм"
            },
            {
                titleC: "Нагрузка",
                descriptionC: "30кг на 1 погон.м."
            }
        ]
    },
    {
        ...
        categories:1,
        src: monkol,
        description: "До установки колонн на каждом ярусе на оголовках нижестоящих колонн закрепляют с помощью винтов одиночные кондукторы. Поднятую краном колонну заводят в хомуты одиночного кондуктора и плавно опускают на оголовок нижестоящей колонны. Колонны приводят в проектное положение с помощью винтов кондуктора, обеспечивая соосность устанавливаемой и нижестоящих колонн. По вертикали их выверяют с помощью верхних винтов кондуктора. Точность приведения колонны в вертикальное положение контролируют теодолитом по двум осям. Несоосность установленных и нижестоящих колонн после выверки не должна превышать 5 мм, а отклонение их от вертикали не более 3 мм.",
        characteristic: [
            {
                titleC: "Сечение",
    ...
    // сюда
    {
        ...
        categories:1,
        src: lextexit,
        description: "Лестница выхода на кровлю предназначена для подъёма на кровлю, для домов серии ПИК. Используется для обслуживания и ремонта дымоходов, мансардных окон, вентиляционных труб, внешних блоков кондиционеров, телевизионных антенн и других элементов.",
        characteristic: [
            {
                titleC: "Высота",
                descriptionC: "3200мм"
